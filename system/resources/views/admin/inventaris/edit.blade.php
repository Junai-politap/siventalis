            ...
            <form action="{{ url('update-inventaris', $inventaris->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="text" class="form-control" name="kode_barang" value="{{ $inventaris->kode_barang }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail2" class="col-3 col-lg-2 col-form-label">Nama Barang</label>
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="text" class="form-control" name="Nama_Barang" value="{{ $inventaris->Nama_Barang }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="text" class="form-control" name="kepemilikan" value="{{ $inventaris->kepemilikan }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail2" class="col-3 col-lg-2 col-form-label">Nomor BMN</label>
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="text" class="form-control" name="no_bmn" value="{{ $inventaris->no_bmn }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail2" class="col-3 col-lg-2 col-form-label">Tahun Pengadaan</label>
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="number" class="form-control" name="Tahun_Pengadaan" value="{{ $inventaris->Tahun_Pengadaan }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="inputEmail2" class="col-3 col-lg-2 col-form-label">Jumlah Barang</label>
                    <div class="col-9 col-lg-10">
                        <input id="inputEmail2" type="text" class="form-control" name="jumlah" value="{{ $inventaris->jumlah }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <img class="img-responsive" src='{{ url("public/$inventaris->Foto") }}' style="object-fit: cover; position: static; width: 80%; height: 100%;">
                    </div>
                    <div class="col-md-6">
                        <input type="file" class="form-control" id="inlineinput" name="Foto" accept=".jpg, .png, .jpeg" value="{{ $inventaris->Foto }}">
                    </div>
                </div>
